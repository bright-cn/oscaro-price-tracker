...
[![Oscaro Price Tracker](https://img.shields.io/badge/Oscaro%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://bright.cn/products/insights/price-tracker/oscaro)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://bright.cn/products/insights/price-tracker/oscaro)

实时 Oscaro 价格追踪——一个电子商务平台。两种开始方式：**全托管**情报平台，或使用 Bright Data 的 AI Scraper Builder 构建的**自定义 scraper**。

---

## 选项 1：Bright Insights - AI 驱动的价格追踪（推荐）

**[Bright Insights](https://bright.cn/products/insights/price-tracker/oscaro)** 是 Bright Data 的全托管零售情报平台。无需构建 scraper，无需维护基础设施——只需将结构化、可直接分析的价格数据交付到 dashboard、data feed 或你的 BI 工具中。
...
**关键使用场景：**
- ✅ 实时**监控 Oscaro 价格**，覆盖数百万 SKU
- ✅ **追踪竞争对手价格**并识别折扣模式
- ✅ **自动调价**，以在 Oscaro 上保持竞争力
- ✅ 监控 MAP 政策合规性并检测价格违规
- ✅ 追踪竞争对手促销及促销动态
- ✅ 将干净、统一的数据直接输入动态定价算法或 AI 模型

> **起价 $250/月 - [获取定制报价 →](https://bright.cn/products/insights/price-tracker/oscaro)**

---

## 选项 2：构建你自己的 Oscaro Scraper

没有预构建的 Oscaro scraper API？没问题。Bright Data 的 **AI Scraper Builder** 只需点击几下即可生成自定义 Oscaro scraper——无需编写代码。

### 在几分钟内构建你的 Oscaro scraper

**[打开 Oscaro AI Scraper Builder →](https://bright.cn/products/web-scraper/oscaro)**
...
- 一个用于 Oscaro 的 **Web Scraper ID**（来自上面的构建步骤）
...
1. **克隆此 repository**
   ...
   ```bash
   git clone https://github.com/bright-cn/oscaro-price-tracker.git
...
3. **配置凭据**
   ...
   > **你的 Web Scraper ID**
   > 将你在 [AI Scraper Builder dashboard](https://bright.cn/products/web-scraper/oscaro) 中的 Web Scraper ID
...
构建好你的 Oscaro scraper 并在 `.env` 中配置好 Web Scraper ID 后，Python 接口的使用方式如下：

### 1. 按 URL 追踪特定产品

传入 Oscaro 产品 URL 列表以获取结构化价格数据：
...
- 🌟 [Oscaro Price Tracker - Bright Insights (Managed)](https://bright.cn/products/insights/price-tracker/oscaro)
- 🏗️ [构建 Oscaro Scraper](https://bright.cn/products/web-scraper/oscaro)
